...
if(!empty($_POST["register"])) {
	require_once("db.php");
	$sql = "INSERT INTO user ( name, email, password, phone, adress, role ) 
	VALUES ( :name, :email, :password, :phone, :adress, :role )";
	$pdo_statement = $conn->prepare( $sql );
		
	$result = $pdo_statement->execute( array( ':name'=>$_POST['name'], ':email'=>$_POST['email'],
	':password'=>$_POST['password'], ':phone'=>$_POST['phone'], ':adress'=>$_POST['adress'], ':role'=>$_POST['role'] ) );
	if (!empty($result) ){
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="customer-login text-left">
                                    ...
                                    <input type="text" placeholder="Phone number here..." name ="phone">
                                    <input type="text" placeholder="Home adress here..." name ="adress">
                                    <input type="password" placeholder="Password" name ="password">
									<input type="hidden" placeholder="Your role here..." name ="role">

									<input type="submit" name="register" class="button-one submit-button mt-15" value="Register" /> 
								</div>					
							</div>
							</form>
						</div>
